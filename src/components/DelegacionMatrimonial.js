                                    ...
                                    <div className="well well-sm">
                                        <form className="form-horizontal" method="post">
                                            <fieldset>
                                                ...
                                                <div className="form-group">
                                                    <span className="col-md-1 col-md-offset-2 text-center"><i className="fa fa-pencil-square-o bigicon"></i></span>
                                                    <textarea onChange={this.onChange('cura')} className="form-control" name="cura" placeholder="Ingrese el nombre del cura" rows="7"></textarea>
                                                </div>

                                                <div className="form-group">
                                                    <span className="col-md-1 col-md-offset-2 text-center"><i className="fa fa-pencil-square-o bigicon"></i></span>
                                                    <textarea onChange={this.onChange('novio')} className="form-control" name="novio" placeholder="Ingrese el nombre del novio" rows="7"></textarea>
                                                </div>

                                                <div className="form-group">
                                                    <span className="col-md-1 col-md-offset-2 text-center"><i className="fa fa-pencil-square-o bigicon"></i></span>
                                                    <textarea onChange={this.onChange('novia')} className="form-control" name="novia" placeholder="Ingrese el nombre de la novia" rows="7"></textarea>
                                                </div>
                                                <div className="form-group">
