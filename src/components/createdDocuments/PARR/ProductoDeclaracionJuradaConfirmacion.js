      ...
      <Document >
        <Page size="A4" style={{
          ...
          <View id="Post">
            ...
            <Text style={{ padding: "2px", fontSize: "12px" }}>                     </Text>
            <Text style={{ padding: "2px", fontSize: "12px", lineHeight: "2px" }}>Art. 2 La presente Declaración Jurada tiene valor de constancia para los fines propios de los que se requiera el presente documento en trámites eclesiásticos dentro y fuera de la diócesis de Alajuela.</Text>
            ...
            <Text style={{ paddingTop: "2px", fontSize: "12px" }} >_____________________________________</Text>
            <Text style={{ fontSize: "12px", lineHeight: "1.5px" }}>{props.testigo}</Text>
            <Text style={{ fontSize: "12px", lineHeight: "1.5px" }}>Ced: {props.cedTestigo}</Text>
