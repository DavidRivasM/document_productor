      ...
      <Document >
        <Page size="A4" style={{
          ...
          <View id="Post">
            ...
            <Text style={{ padding: "2px", fontSize: "12px", lineHeight: "2px"  }}>   </Text>
            <Text style={{ padding: "2px", fontSize: "15px", lineHeight: "2px", margin: "auto" }}>{props.nombreFeligres}</Text>
            <Text style={{ padding: "2px", fontSize: "15px", lineHeight: "2px", margin: "auto" }}>CEDULA: {props.cedFeligres}</Text>
            <Text style={{ padding: "2px", fontSize: "12px", lineHeight: "2px"  }}>   </Text>
