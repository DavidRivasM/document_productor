        ...
        <div className='homeParr'>
            ...
            <div className="row">
                ...
                <div className="col-sm-6">
                    <div className="card">
                        <div className="card-body">
                            <h5 className="card-title">Declaración jurada de la Confirmación</h5>
                ...
                <div className="col-sm-6">
                    <div className="card">
                        <div className="card-body">
                            ...
                            <p className="card-text">Documento que hace una solicitud para realizar un trámite de nulidad sobre un matrimonio en partiicular.</p>
                            {
                ...
                <div className="col-sm-6">
                    <div className="card">
                        <div className="card-body">
                            <h5 className="card-title">Portada de envio de documentos al Tribunal Eclesiástico</h5>
                ...
                <div className="col-sm-6">
                    <div className="card">
                        <div className="card-body">
                            <h5 className="card-title">Solicitud Talonario de Matrimonios</h5>
                ...
                <div className="col-sm-6">
                    <div className="card">
                        <div className="card-body">
                            <h5 className="card-title">Permiso para matricula de catequesis/confirmacion en otra parroquia.</h5>
                ...
                <div className="col-sm-6">
                    <div className="card">
                        <div className="card-body">
                            <h5 className="card-title">Carta para celebrar matrimonio.</h5>
                ...
                <div className="col-sm-6">
                    <div className="card">
                        <div className="card-body">
                            <h5 className="card-title">Permiso Catequesis prematrimonial.</h5>
                ...
                <div className="col-sm-6">
                    <div className="card">
                        <div className="card-body">
                            <h5 className="card-title">Boleta de inscripción a Catequesis bautismal.</h5>
