...
import ProductoPoderEspecial from '../../createdDocuments/CUDA/ProductoPoderEspecial';
import { PDFDownloadLink } from "@react-pdf/renderer";

class PoderEspecial extends Component {
    state = {
        consecutivo: '',
        apoderado: '',
        puesto: '',
                ...
                {!this.state.postSubmitted ?
                    (
                        ...
                        <div>
                            ...
                            <PDFDownloadLink
                                document={<ProductoPoderEspecial consecutivo={this.state.consecutivo} apoderado={this.state.apoderado} puesto={this.state.puesto} cedApoderado={this.state.cedApoderado} solicitud={this.state.solicitud} fecha={this.state.fecha} destinatario={this.state.destinatario} fechaSolicitud={this.state.fechaSolicitud} />}
