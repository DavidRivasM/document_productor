...
import ProductoListaRemision from '../../createdDocuments/PARR/ProductoListaRemision';

class ListaRemision extends Component {
                ...
                {!this.state.postSubmitted ?
                    (
                                    ...
                                    <div className="well well-sm">
                                        <form className="form-horizontal" method="post">
                                            <fieldset>
                                                ...
                                                <div className="form-group">
                                                    <span className="col-md-1 col-md-offset-2 text-center"><i className="fa fa-pencil-square-o bigicon">Ingrese el nombre de la unidad administrativa que va transferir documentos.</i></span>
                                                    <input onChange={this.onChange('unidad')} name="unidad" type="text" placeholder="Oficina parroquial" className="form-control" />
                                                </div>

                                                <div className="form-group">
                                                    <span className="col-md-1 col-md-offset-2 text-center"><i className="fa fa-pencil-square-o bigicon">Ingrese el nombre de la persona que realiza el proceso de transferencia.</i></span>
                                                    <input onChange={this.onChange('responsable')} name="responsable" type="text" placeholder="Pedro Mora Chavarría" className="form-control" />
                                                </div>

                                                <div className="form-group">
                                                    <span className="col-md-1 col-md-offset-2 text-center"><i className="fa fa-pencil-square-o bigicon">Ingrese la fecha de la transferencia de documentos.</i></span>
                                                    <input onChange={this.onChange('fechaEnvio')} name="fechaEnvio" type="text" placeholder="2 de enero de 2023" className="form-control" />
                                                </div>

                                                <div className="form-group">
                                                    <span className="col-md-1 col-md-offset-2 text-center"><i className="fa fa-pencil-square-o bigicon">Ingrese el número de la tranferencia.</i></span>
                                                    <input onChange={this.onChange('numeroTransferencia')} name="numeroTransferencia" type="text" placeholder="01" className="form-control" />
                                                </div>
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input onChange={this.onChange('cura')} name="cura" type="text" placeholder="Karol Józef Wojtyła" className="form-control" />
                                                </div>
                        ...
                        <div>
                            ...
                            <PDFDownloadLink
                                document={<ProductoListaRemision parroquia={this.state.parroquia} consecutivo={this.state.consecutivo} unidad={this.state.unidad} responsable={this.state.responsable} fechaEnvio={this.state.fechaEnvio} numeroTransferencia={this.state.numeroTransferencia} 
                                
                                tel={this.state.tel} cura={this.state.cura} email={this.state.email} web={this.state.web} image={this.state.image} codigo={this.state.codigo} lugar={this.state.lugar}  />}
                                fileName={this.state.codigo + '-' + 'LRD' + '-' + this.state.consecutivo}                            >
