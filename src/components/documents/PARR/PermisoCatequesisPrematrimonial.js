                                        ...
                                        <form className="form-horizontal" method="post">
                                            <fieldset>
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input onChange={this.onChange('lugarTrabajoDestinatario')} name="lugarTrabajoDestinatario" type="text" placeholder="Parroquia de Alajuelita" className="form-control" />
                                                </div>
