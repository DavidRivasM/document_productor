                                        ...
                                        <form className="form-horizontal" method="post">
                                            <fieldset>
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input onChange={this.onChange('nombreNovio')} name="nombreNovio" type="text" placeholder="Pedro Murillo Rivera" className="form-control" />
                                                </div>
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input onChange={this.onChange('nombreNovia')} name="nombreNovia" type="text" placeholder="Veronica Alfaro Mora" className="form-control" />
                                                </div>
